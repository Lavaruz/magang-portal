        ...
        <div class="mt-4 grid grid-cols-[450px_1fr] gap-3">
            ...
            <div class="job-button w-100 divide-header divide-y">
                ...
                <div class="w-100 flex flex-col gap-2 py-4">
                    ...
                    <a target="_blank" href="/posts/${post.id}/recruiter"><button class="gap-2 flex m-auto w-full py-3 text-white font-second text-xs font-medium justify-center rounded-lg bg-[#343434]"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
